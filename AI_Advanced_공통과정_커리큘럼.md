...
| 시간 | 내용 | 형태 |
|------|------|------|
| 09:00–09:20 | 오리엔테이션: 전체 과정 구조, 8일 로드맵, GitHub 운영 방침 안내 | 전체 |
| 09:20–10:30 | **GitHub 환경 구성 + Git 기초**: 계정 생성, 저장소 클론, `.gitignore` 이해, 첫 커밋 실습 | 강의+실습 |
| 10:30–10:40 | 휴식 | |
| 10:40–11:40 | **AI/LLM 원리 + 토큰 경제학 + 9개 모델 라우팅**: 생성형 AI 작동 원리, 한국어 토큰 소모량(영어의 3~5배), 컨텍스트 윈도우, Gemini 모델 라인업(Ultra·Pro·Flash·Nano) | 강의 |
| 11:40–12:00 | **실습**: ChatGPT·Claude·Gemini 3종에 동일 프롬프트 입력 → 반응 차이 비교 분석 | 실습 |
| 12:00–13:00 | 점심 | |
| 13:00–13:50 | **CRGR + PTCF 프롬프트 엔지니어링**: 맥락(C)·참조(R)·목표(G)·역질문(R) 프레임워크, PTCF(Persona·Task·Context·Format) 단계적 지시 기법, 교수 목적 기반 프롬프트 유형 분류 | 강의+실습 |
| 13:50–14:50 | **Bloom 분류학 + 강의 계획서 AI 생성**: Bloom 기반 학습 목표 재작성, 16주 강의 계획서 초안 AI 생성, 수업목표↔강의안↔평가 정합성 자가 검증 | 실습 |
| 14:50–15:00 | 산출물 `.md` 파일 정리 → `git add` → `git commit` → `git push` | 정리 |
...
| 시간 | 내용 | 형태 |
|------|------|------|
| 09:00–09:10 | 전날 산출물 GitHub 확인, 당일 목표 안내 | 전체 |
| 09:10–10:10 | **학습자료 유형 + Gems PTCF 설계**: 3단계 체계화(도입·전개·정리), Google Gems 루브릭 설계 PTCF 활용, Qwen 난이도 조정, Grok 최신 사례 | 강의 |
| 10:10–10:20 | 휴식 | |
| 10:20–11:20 | **NotebookLM 7가지 업로드 + 9가지 스튜디오**: PDF·URL·YouTube·Drive 업로드, AI 오디오 오버뷰·슬라이드·마인드맵·퀴즈·플래시카드 생성 | 강의+실습 |
| 11:20–12:00 | **실습**: 수업 단계별 학습자료 3종 (도입·전개·정리) AI 생성 및 상호 피드백 | 실습 |
| 12:00–13:00 | 점심 | |
| 13:00–14:00 | **AI 통합 수업 운영 전략**: TimelyGPT 4단계 마스터리(기본 상호작용→템플릿→Labs→에이전트), 수업 단계별 AI 활용 프레임워크, 학습자 참여 유도 전략 | 강의+실습 |
| 14:00–14:50 | **AI 보안 + 프롬프트 인젝션 & 방어**: 보안 위협 유형, 익명화 처리, Llama 로컬 처리, 인젝션 공격 시도 → 방어 모델 작성 | 강의+실습 |
| 14:50–15:00 | 산출물 정리 → GitHub 커밋·푸시 | 정리 |
...
|------|------|------|
| 09:00–09:10 | 전날 산출물 GitHub 확인, 당일 목표 안내 | 전체 |
| 09:10–10:10 | **평가 설계 원리 + CA 관점 검점**: 진단·형성·총괄 평가, AI 활용 가능/불가 영역 구분, Constructive Alignment 3요소(LO·TLA·AT) 일관성 점검 | 강의 |
| 10:10–10:20 | 휴식 | |
| 10:20–11:30 | **Google Gems 루브릭 설계 + 계열별 평가 문항 생성**: PTCF 기반 젬스 지침 설계, 4단계 분석적 루브릭 생성, 루브릭 품질 점검 5대 기준 적용, ChatGPT 시험 문항·Claude 루브릭·피드백 분업 | 강의+실습 |
| 11:30–12:00 | **실습**: 본인 교과목 시험 문제 세트 + 4~5단계 채점 루브릭 완성 | 실습 |
| 12:00–13:00 | 점심 | |
| 13:00–14:00 | **학생 피드백 자동 생성 + NotebookLM 평가 자료 관리**: Claude 개인화 피드백, Mistral 압축형 피드백 비교, NotebookLM 퀴즈·플래시카드 자동 생성 | 강의+실습 |
| 14:00–14:50 | **실습**: 학생 피드백 문장집 완성 (3수준 답안 기반) | 실습 |
| 14:50–15:00 | 산출물 정리 → GitHub 커밋·푸시 | 정리 |
...
|------|------|------|
| 09:00–09:10 | 전날 산출물 GitHub 확인, 당일 목표 안내 | 전체 |
| 09:10–10:20 | **AI 품질 관리 원칙 + 오류 탐지 실습**: 사실 정확성·학문적 타당성·편향 탐지 기준, 문서 유형별 품질 기준 차이, 재생성 루프, Perplexity 교차 검증 | 강의+실습 |
| 10:20–10:30 | 휴식 | |
| 10:30–11:20 | **AI 기반 수업 혁신 + 교수자 역할 변화**: 지식 전달자→학습 설계자·큐레이터, 3단계 피드백 사이클(AI 1차→학생 검토→교수자 심층), AI-Resistant 평가 설계, 국내외 대학 혁신 사례(Grok 탐색) | 강의 |
| 11:20–12:00 | **AI 저작권 + 학문적 무결성**: 2025년 최신 판례(Getty Images v. Stability AI, Bartz v. Anthropic), 학문적 무결성 3유형(Learning Aid·AI-Integrated·Ethics Only), 대학 정책 현황 | 강의 |
| 12:00–13:00 | 점심 | |
| 13:00–14:00 | **개인 AI 활용 교수 프로토콜 수립**: AI 리터러시 4대 영역(기술적·비판적·윤리적·교육적), 교과목별 AI 활용 범위·도구·검증 절차·윤리 기준 작성 | 실습 |
| 14:00–14:40 | **계열별 최종 발표 (2인 1조 피어리뷰)** | 발표 |
| 14:40–15:00 | 전체 공통 과정 회고 + GitHub 최종 커밋·푸시 | 정리 |
